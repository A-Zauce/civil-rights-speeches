...
declare variable $seale-speeches := $speeches//Q{}speech[@speaker="b_seale"];
...
<g>
<text x="0" y="-5" font-family="" font-size="" fill="">Frequency of Acts by Bobby Seale</text>
</g>
<g>
    ...
    <line x1="0" y1="100"
    x2="{let $actcount := $seale-speeches//Q{}act[@cat="active-resistance"] => count() div $seale-speeches//Q{}act=>count()
    return $actcount * $xspacer}"
    y2="100" stroke-width="{$bar-width}" stroke="red"/>
    
    <line x1="{let $actcount := $seale-speeches//Q{}act[@cat="active-resistance"] => count() div $seale-speeches//Q{}act=>count()
    return $actcount * $xspacer}" y1="100"
    x2="{let $actcount := $seale-speeches//Q{}act[@cat="active-resistance" or @cat="self-defense"] => count() div $seale-speeches//Q{}act=>count()
    return $actcount * $xspacer}"
    y2="100" stroke-width="{$bar-width}" stroke="yellow"/>
    
    <line x1="{let $actcount := $seale-speeches//Q{}act[@cat="active-resistance" or @cat="self-defense"] =>count() div $seale-speeches//Q{}act=>count()
    return $actcount * $xspacer}" y1="100"
    x2="{$xspacer}"
