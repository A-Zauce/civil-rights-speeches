...
declare variable $speeches:=collection(' ../../xml/xml-wip/*.xml');
...
<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
        ...
        <g>
        <text x ="0" y="-5" font-family="garamond"  font-size="30px" fill="black"> Organization Mentions in Civil Rights Speeches"</text>
        </g>
            <g>
        {
